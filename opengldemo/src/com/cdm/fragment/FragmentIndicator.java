	...
	public FragmentIndicator(Context context, AttributeSet attrs) {
	 ...
	 private View createIndicator(int iconResID, int stringResID, int stringColor,   
	    ...
	    private void init() { 
	        ...
	        mIndicators[0] = createIndicator(R.drawable.schoolnormal,  
	                R.string.bottom_school, COLOR_SELECT, TAG_ICON_0, TAG_TEXT_0);  
	        mIndicators[1].setBackgroundColor(Color.alpha(0));
	        mIndicators[0].setTag(Integer.valueOf(0));  
	        mIndicators[0].setOnClickListener(this);  
	        addView(mIndicators[0]);  
	        mIndicators[1] = createIndicator(R.drawable.msgnormal,
	                R.string.msg_school, COLOR_UNSELECT, TAG_ICON_1, TAG_TEXT_1);  
	        mIndicators[1].setBackgroundColor(Color.alpha(0));  
	        mIndicators[1].setTag(Integer.valueOf(1));  
	        mIndicators[1].setOnClickListener(this);  
	        addView(mIndicators[1]);  
	        mIndicators[2] = createIndicator(R.drawable.topicnormal,  
	                R.string.topic_school, COLOR_UNSELECT, TAG_ICON_2, TAG_TEXT_2);  
	    ...
	    public static void setIndicator(int which) {
	        ...
	        switch(mCurIndicator) {  
		        case 0:  
		            ...
		            prevIcon.setImageResource(R.drawable.schoolnormal);  
		        ...
		        case 1:  
		            ...
		            prevIcon.setImageResource(R.drawable.msgnormal);  
		        ...
		        case 2:  
		            ...
		            prevIcon.setImageResource(R.drawable.topicnormal);  
	       ...
	       // mIndicators[which].setBackgroundResource(R.drawable.indic_select);  
	        ...
	        case 0:  
	            ...
	            currIcon.setImageResource(R.drawable.schoolselected);  
	        ...
	        case 1:  
	            ...
	            currIcon.setImageResource(R.drawable.msgselect);  
	        ...
	        case 2:  
	            ...
	            currIcon.setImageResource(R.drawable.topicselect);  
