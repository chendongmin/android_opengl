...
public class Ball6_3 {
	...
	float r = 0.8f;
	public Ball6_3(GLSurfaceView mv) {
		// 初始化顶点坐标与着色数据
		initVertexData();
		// 初始化shader
		initShader(mv);
	...
	public void initShader(GLSurfaceView mv) {
		// 加载顶点着色器的脚本内容
		mVertexShader = ShaderUtil.loadFromAssetsFile("vertex6_3.sh",
				mv.getResources());
		// 加载片元着色器的脚本内容
		mFragmentShader = ShaderUtil.loadFromAssetsFile("frag6_3.sh",
				mv.getResources());
		// 基于顶点着色器与片元着色器创建程序
