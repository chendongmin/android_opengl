...
import static com.cdm.opengl.util.Constant.ratio;
...
import com.cdm.opengl.view.MySurfaceView9;

public class Sample5_10Activity extends Activity {
	private MySurfaceView9 mGLSurfaceView;
    @Override
    protected void onCreate(Bundle savedInstanceState) 
    {
 		...
 		//切换到主界面
 		setContentView(R.layout.sample5_10);		
 		//初始化GLSurfaceView
         mGLSurfaceView = new MySurfaceView9(this);
         mGLSurfaceView.requestFocus();//获取焦点
         mGLSurfaceView.setFocusableInTouchMode(true);//设置为可触控  
         //将自定义的GLSurfaceView添加到外层LinearLayout中
         LinearLayout ll=(LinearLayout)findViewById(R.id.main_liner10); 
