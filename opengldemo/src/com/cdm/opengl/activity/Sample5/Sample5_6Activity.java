...
import com.cdm.opengl.view.MySurfaceView5;

public class Sample5_6Activity extends Activity {
	private MySurfaceView5 mGLSurfaceView;
	RadioButton rb0;
	RadioButton rb1;
	RadioButton rb2;
	RadioButton rb3;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// 切换到主界面
		setContentView(R.layout.sample5_6);
