...
public class MySurfaceView8 extends GLSurfaceView 
{
    private SceneRenderer mRenderer;//场景渲染器
    
	public MySurfaceView8(Context context) {
        super(context);
    ...
    {   
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //创建点或线对象
            belt = new Belt5_9(MySurfaceView8.this);
            circle = new Circle5_9(MySurfaceView8.this);
            //打开深度检测
