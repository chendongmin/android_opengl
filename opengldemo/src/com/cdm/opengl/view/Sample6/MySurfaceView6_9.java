...
import com.cdm.opengl.shape.Sample6.Ball6_9;
import com.cdm.opengl.util.Constant;
import com.cdm.opengl.util.MatrixState;

public class MySurfaceView6_9 extends GLSurfaceView 
{
	...
	public MySurfaceView6_9(Context context) {
        super(context);
	...
	private class SceneRenderer implements GLSurfaceView.Renderer 
    {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //创建球对象
            ball=new Ball6_9(MySurfaceView6_9.this);
            //打开深度检测
