...
import com.cdm.opengl.shape.Sample6.Ball6_4;
import com.cdm.opengl.util.Constant;
import com.cdm.opengl.util.MatrixState;

public class MySurfaceView6_4 extends GLSurfaceView 
{
	...
	public MySurfaceView6_4(Context context) {
        super(context);
	...
	private class SceneRenderer implements GLSurfaceView.Renderer 
    {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //创建球对象
            ball=new Ball6_4(MySurfaceView6_4.this);
            //打开深度检测
