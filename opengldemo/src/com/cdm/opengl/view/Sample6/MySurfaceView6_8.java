...
import com.cdm.opengl.shape.Sample6.Cube6_8;
import com.cdm.opengl.util.Constant;
import com.cdm.opengl.util.MatrixState;

public class MySurfaceView6_8 extends GLSurfaceView 
{
	...
	public MySurfaceView6_8(Context context) {
        super(context);
	...
	private class SceneRenderer implements GLSurfaceView.Renderer 
    {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //创建球对象
            cube=new Cube6_8(MySurfaceView6_8.this);
            //打开深度检测
