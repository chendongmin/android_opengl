...
import com.cdm.opengl.shape.Sample6.Ball6_10;
import com.cdm.opengl.util.Constant;
import com.cdm.opengl.util.MatrixState;

public class MySurfaceView6_10 extends GLSurfaceView 
{
	...
	public MySurfaceView6_10(Context context) {
        super(context);
	...
	private class SceneRenderer implements GLSurfaceView.Renderer 
    {
        ...
        public void onSurfaceChanged(GL10 gl, int width, int height) {
			...
			// 调用此方法计算产生透视投影矩阵
            MatrixState.setProjectFrustum(-Constant.ratio, Constant.ratio, -1, 1, 25, 100);
			// 调用此方法产生摄像机9参数位置矩阵
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //创建球对象
            ball=new Ball6_10(MySurfaceView6_10.this);
            //打开深度检测
